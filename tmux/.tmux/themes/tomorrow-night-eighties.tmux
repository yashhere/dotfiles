...
set -g message-style bg="#66cccc",fg="#000000",bg="#2d2d2d",fg="#cc99cc"
...
set-window-option -g window-status-current-style bg="#393939",fg="#6699cc",none
set-window-option -g window-status-current-format '#[fg=#f99157,bg=#2d2d2d] #I #[fg=#cccccc,bg=#393939] #W #[default]'

# active terminal yellow border, non-active white
set -g pane-border-style bg=default,fg="#515151",bg=default,fg="#999999"
set -g pane-active-border-style bg=default,fg="#515151",fg="#f99157"
